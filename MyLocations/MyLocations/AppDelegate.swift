...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func listenForFatalCoreDataNotifications() {
        NotificationCenter.default.addObserver(forName: MyManagedObjectContextSavedDidFailNotification, object: nil, queue: OperationQueue.main, using: { notification in
